...
//! the inherited environment, discards standard error, and kills a child that
//! outlives its registered deadline. This is not an operating-system sandbox:
//! the child inherits the current directory and ordinary filesystem and network
//! privileges. Candidate wiring must supply a separately qualified isolation
//! boundary before using an untrusted host executable.
