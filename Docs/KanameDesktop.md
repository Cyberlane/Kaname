...
- The inspector is a single resizable surface with its own stable search field, while the primary content actions remain grouped together in the center toolbar.
